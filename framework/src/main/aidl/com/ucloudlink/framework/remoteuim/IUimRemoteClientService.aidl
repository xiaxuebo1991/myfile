...
interface IUimRemoteClientService {
     ...
     *    UIM_REMOTE_ERROR         = 1;
     */
    int uimRemoteEvent(in int slot, in int event, in byte[] atr, in int errCode, int tranSport, int usage, int apdu_timeout, int disable_all_polling, int poll_timer);
    /**
